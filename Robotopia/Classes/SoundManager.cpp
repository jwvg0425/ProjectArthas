...
bool SoundManager::init()
{
	...
	CocosDenshion::SimpleAudioEngine::getInstance()->preloadEffect("Sound/메뉴키고글때.ogg");
	CocosDenshion::SimpleAudioEngine::getInstance()->preloadEffect("Sound/SteamGet.wav");

	////일반행동
	CocosDenshion::SimpleAudioEngine::getInstance()->preloadEffect("Sound/기어바꿀때.ogg");
	CocosDenshion::SimpleAudioEngine::getInstance()->preloadEffect("Sound/점프.ogg");

	////근거리상태
	CocosDenshion::SimpleAudioEngine::getInstance()->preloadEffect("Sound/근거리미사일주먹.ogg");
	CocosDenshion::SimpleAudioEngine::getInstance()->preloadEffect("Sound/슈퍼아머.ogg");
	CocosDenshion::SimpleAudioEngine::getInstance()->preloadEffect("Sound/무적.ogg");

	////원거리상태
	CocosDenshion::SimpleAudioEngine::getInstance()->preloadEffect("Sound/원거리미사일.ogg");
	...
	CocosDenshion::SimpleAudioEngine::getInstance()->preloadEffect("Sound/공중방사형미사일.ogg");
	CocosDenshion::SimpleAudioEngine::getInstance()->preloadEffect("Sound/공중일반미사일.ogg");
	////일반 스킬
	CocosDenshion::SimpleAudioEngine::getInstance()->preloadEffect("Sound/대쉬.wav");

	//normalMonster
	////몬스터 공통
	CocosDenshion::SimpleAudioEngine::getInstance()->preloadEffect("Sound/몬스터맞을때.ogg");

	////돼지
	CocosDenshion::SimpleAudioEngine::getInstance()->preloadEffect("Sound/돼지소리.ogg");

	////데빌 몬스터
	CocosDenshion::SimpleAudioEngine::getInstance()->preloadEffect("Sound/번개.wav");

	////고등어
	CocosDenshion::SimpleAudioEngine::getInstance()->preloadEffect("Sound/고등어미사일쏘는소리.ogg");
	...
	CocosDenshion::SimpleAudioEngine::getInstance()->preloadEffect("Sound/시작화면에서잘못클릭.ogg");
